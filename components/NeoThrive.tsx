...
export default function NeoThrive() {
  return (
    <section className="relative w-full bg-[#12103D] py-28 sm:py-36 px-6 sm:px-12 overflow-hidden text-white border-t border-[#28245F]/50">
      <div className="relative z-10 mx-auto max-w-7xl">
        {/* Open Editorial Layout: Header + 3 Clean Typographic Columns */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start pb-16 border-b border-[#28245F]/40">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.08]">
              Engage Every Attendee.
            </h2>
            <p className="text-base sm:text-lg text-[#E3E6EF]/75 leading-relaxed font-light">
          ...
          {/* Right Open Typographic Pillars - Zero Box Clutter */}
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 lg:gap-8 pt-4 lg:pt-0">
            {PILLARS.map((pillar) => (
              <div key={pillar.num} className="space-y-4 flex flex-col justify-between">
                <div>
                  <span className="font-mono text-sm font-bold text-[#8EDAF2] block mb-3">
                    {pillar.num}
                  </span>
                ...
                <div className="pt-4 border-t border-[#28245F]/40">
