      ...
      >
        <div
          className={`mx-auto flex items-center justify-between transition-all duration-500 ${
            isScrolled
              ? "max-w-6xl rounded-full bg-[#12103D]/90 px-6 py-2.5 shadow-[0_12px_40px_rgba(18,16,61,0.6)] backdrop-blur-2xl"
              : "max-w-7xl"
          }`}
        >
          ...
          <button
            ...
            className="flex md:hidden flex-col items-center justify-center w-10 h-10 rounded-full bg-[#28245F]/50 text-white backdrop-blur-md focus:outline-none"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 flex flex-col bg-[#12103D]/98 px-8 pt-32 pb-12 backdrop-blur-2xl md:hidden"
          >
              ...
              {NAV_LINKS.map((link, idx) => (
                ...
                >
                  <Link
                    ...
                    className="font-display text-2xl font-bold tracking-tight text-white hover:text-[#8EDAF2]"
                  >
                    {link.name}
                  </Link>
                </motion.div>
            ...
            <div className="mt-auto pt-8 border-t border-[#28245F]">
              <p className="text-xs uppercase tracking-[0.2em] font-mono text-[#8EDAF2] mb-4">
