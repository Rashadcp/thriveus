...
export const PRODUCTIONS: ProductionItem[] = [
  {
    id: "work-01-channel-partner-award",
    refCode: "V1",
    ...
    description:
      "A recognition evening for SPC Free Zone's channel partner network (CELESTE 2026): staging, entertainment, custom awards and more than 200 curated gift boxes, engineered so every partner left feeling individually acknowledged.",
    image: "https://i.ytimg.com/vi/uUE_j7b9VEg/maxresdefault.jpg",
    backupImage: "/images/gala-dinner-ballroom.jpg",
    youtubeId: "uUE_j7b9VEg",
  },
  {
    id: "work-02-mountain-retreat",
    refCode: "V2",
    ...
    description:
      "A leadership retreat in the foothills of Jebel Hafeet for the regional management team of Subsea7, pairing structured strategy sessions with facilitated leadership challenges, mindfulness, and an inspiring Commitment Tree ceremony.",
  ...
  {
    id: "work-03-arena-games",
    refCode: "V3",
    tag: "SIGNATURE FORMAT",
    category: "Signature Formats",
    title: "The Arena Games · Annual Staff Event",
    meta: "300+ guests · Dubai · February 2026",
    description:
      "A full arena production for the annual staff event of a global engineering consultancy. Our Squid Game inspired arena format brought custom game zones, elimination style rounds, live scoring and a survival themed storyline that turned colleagues into competing squads for one unforgettable afternoon.",
  ...
  {
    id: "work-04-white-and-glam",
    refCode: "V4",
    tag: "YEAR-END CELEBRATION",
    category: "Celebrations & Galas",
    title: "White & Glam · Year-End Celebration",
    meta: "Corporate Gala · Dubai",
    description:
      "A high-energy White & Glam themed corporate celebration designed around immersive entertainment, custom styling, interactive experiences, music, and shared moments to celebrate team achievements and end the year on a high.",
  ...
  {
    id: "work-05-desert-challenge",
    refCode: "V5",
    tag: "DESERT CHALLENGE",
    category: "Team Challenges",
    title: "Desert Team Challenge · Battle for Supremacy",
    meta: "80 participants · Private Desert UAE",
    description:
      "A custom physical challenge taking 80 participants deep into a private desert for high-stakes competition built around rival team identities, flag captures, dune battles, and an evening BBQ lounge built from scratch under the stars.",
    image: "https://i.ytimg.com/vi/lYgZKVe1UIk/maxresdefault.jpg",
    backupImage: "/images/gallery-desert-camp.jpg",
  ...
  },
  {
    ...
    meta: "350 guests · Cultural Themed Event",
    description:
