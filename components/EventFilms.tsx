                  ...
                  <div className="relative aspect-video w-full overflow-hidden rounded-xl bg-[#0B0A0D] border border-[#242057]">
                    ...
                    {isWarmed && (
                      <iframe
                        ...
                        src={`https://www.youtube.com/embed/${film.youtubeId}?enablejsapi=1&autoplay=${
                          isPlaying ? "1" : "0"
                    ...
                    >
                      ...
                      >
                        {isLoading ? (
                          <div className="flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-[#1782A8] text-white shadow-[0_0_35px_rgba(23,130,168,0.9)] animate-pulse">
                    ...
                    {isPlaying && (
                      <button
                        ...
                        className="absolute top-2.5 right-2.5 z-30 flex h-7 w-7 items-center justify-center rounded-full bg-[#0B0A0D]/85 backdrop-blur-md text-white/90 hover:text-white hover:bg-[#1782A8] transition-colors border border-white/15 cursor-pointer shadow-md"
